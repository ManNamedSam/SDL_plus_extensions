...
const generic_src_files = [_][]const u8{
    ...
    "src/mixer/effect_position.c",
    "src/mixer/effect_stereoreverse.c",
    "src/mixer/effects_internal.c",
    "src/mixer/mixer.c",
    "src/mixer/music.c",
    "src/mixer/utils.c",

    "src/image/IMG_avif.c",
    "src/image/IMG_bmp.c",
    "src/image/IMG_gif.c",
    "src/image/IMG_jpg.c",
    "src/image/IMG_jxl.c",
    ...
    "src/image/IMG_xxx.c",
    "src/image/IMG.c",
    "src/mixer/codecs/load_aiff.c",
    "src/mixer/codecs/load_voc.c",
    "src/mixer/codecs/mp3utils.c",
    "src/mixer/codecs/music_cmd.c",
    "src/mixer/codecs/music_drflac.c",
    "src/mixer/codecs/music_drmp3.c",
    "src/mixer/codecs/music_flac.c",
    "src/mixer/codecs/music_fluidsynth.c",
    "src/mixer/codecs/music_gme.c",
    "src/mixer/codecs/music_modplug.c",
    "src/mixer/codecs/music_mpg123.c",
    "src/mixer/codecs/music_mpg123.c",
    "src/mixer/codecs/music_nativemidi.c",
    "src/mixer/codecs/music_ogg_stb.c",
    "src/mixer/codecs/music_ogg.c",
    "src/mixer/codecs/music_opus.c",
    "src/mixer/codecs/music_timidity.c",
    "src/mixer/codecs/music_wav.c",
    "src/mixer/codecs/music_xmp.c",
    "src/mixer/codecs/music_wavpack.c",
};
